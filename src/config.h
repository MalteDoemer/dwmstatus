...
static const block_t blocks[] = {
    ...
    {  " %s",               volume_icon_alsa,   "Master",     toggle_vol,       0,         SIG_VOLUME },
    {  " %s%% |",           volume_alsa,        "Master",     toggle_vol,       0,         SIG_VOLUME },
    {  " %s",               powerprofile_icon,  NULL,         "powerprofile",   0,         SIG_POWER_PROFILE },
    {  " %s ",              battery_icon,       "BAT0",       "powerprofile",   30,         0 },
    {  " %s%% |",           battery_perc,       "BAT0",       "powerprofile",   30,         0 },
    {  "  %s |",          keyboard_layout,    NULL,          NULL,             0,         SIG_KEYBOARD },
    {  "  %s |",          wifi_essid,         "wlo1",        "wifimenu",       0,         SIG_NETWORK },
    {  "%s |",              date,               "%F %T",      NULL,             1,         0 },
